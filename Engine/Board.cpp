...
void Board::DrawBorder()
{
	...
	gfx.DrawRect(left, top, right, top + borderWidth, c);
	gfx.DrawRect(left, bottom - borderWidth, right, bottom, c);
	gfx.DrawRect(left, top + borderWidth, left + borderWidth, bottom - borderWidth, c);
	gfx.DrawRect(right - borderWidth, top + borderWidth, right, bottom - borderWidth, c);
}
